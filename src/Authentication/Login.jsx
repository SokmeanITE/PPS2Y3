            ...
            <div class="panel border bg-white">
                ...
                <div class="panel-body p-3">
                    <form action="login_script.php" method="POST">
                        ...
                        <div class="btn btn-primary btn-block mt-3">Log In <a href="/"> </a> </div>
                        <div class="text-center pt-4 text-muted">Don't have an account? <a href="Signup">Sign Up</a> </div>
                    </form>
                </div>
                <div class="mx-3 my-2 py-2 bordert">
                    <div class="text-center py-3"> <a href="https://wwww.facebook.com" target="_blank" class="px-2"> <img src="https://www.facebook.com/images/fb_icon_325x325.png" alt=""/> </a> <a href="https://www.google.com" target="_blank" class="px-2"> 
